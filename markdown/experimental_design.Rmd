...
By the end of this lab student should be able to
   ...
   + List and describe Fisher's three principals of experimental designs
       ...
       + Replication
       + Local Control
   + Identify the type of design used in given case studies
...
We should repeat an experiment to fully assess variability and enable us to (with caution) generalize results. Here, each group member is tested **multiple** times or under **different** conditions.
...
**Types** 
 ...
 + Crossover design: participants assigned all treatments, and the results are measured over time 
...
```{r url2}
knitr::include_url("https://enveurope.springeropen.com/articles/10.1186/s12302-015-0060-7",height = "200px")
```
...
Then each group should pair up with another group and present the design, results, and flaws of [this study](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0077193). This should be done **as a group** and the presentation should last no more than 5 minutes. In this exercise you will be peer reviewed so in your pairs of groups you **must** [fill out this form](https://docs.google.com/forms/d/e/1FAIpQLSeMZDLBiDVTNzoKR7vAZmHLflN0qcIfFeowIuNclvgDLfDBjg/viewform?usp=sf_link).
