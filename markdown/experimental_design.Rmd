...
### Get into groups of 4--6 and
   ...
   1. Discuss the [pre lab reading]. Talk about the flaws in the statistical analysis and/or experimental design. Use [this form]() to record your answers/thoughts.
   
   2. Design your own experiment (worth 6\% of your final grade)
...
Then each group should pair up with another group and present their design, results, and flaws **as a group** for 5 minutes. In this exercise you will be peer reviewed so in your pairs of groups you **must** [fill out this form](https://docs.google.com/forms/d/e/1FAIpQLSeMZDLBiDVTNzoKR7vAZmHLflN0qcIfFeowIuNclvgDLfDBjg/viewform?usp=sf_link)]
