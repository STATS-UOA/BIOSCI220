...
Discuss the [pre lab reading]. Talk about the flaws in the statistical analysis and/or experimental design. Use [this form]() to record your answers/thoughts.
...
Then each group should pair up with another group and present the design, results, and flaws of the study. This should be done **as a group** and the presentation should last no more than 5 minutes. In this exercise you will be peer reviewed so in your pairs of groups you **must** [fill out this form](https://docs.google.com/forms/d/e/1FAIpQLSeMZDLBiDVTNzoKR7vAZmHLflN0qcIfFeowIuNclvgDLfDBjg/viewform?usp=sf_link).
