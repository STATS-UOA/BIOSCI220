...
plot(1:15, rep(1,15),col = rep(col,each = 5),pch = 20,axes = FALSE, xlab = "",ylab = "",cex = 4);
legend("topleft",bty = "n",pch = 20, col = col, legend = c("Group 1","Group 2", "Control"))
...
As part of your assessed lab work this week you are to design your own experiment. Please upload a .pdf of your answers to the following to CANVAS before the deadline. Please head over to the Assignment page of CANVAS for more details.
...
```
 ...
 + Design an experiment that could help you test the hypothesis/answer your question of interest. Write a few short paragraphs outlining the experimental design describing how Fisher's three principles of experimental design have played a part.
