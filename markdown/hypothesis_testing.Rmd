...
Probability of getting a t-statistic at least as extreme as the one we observe (think of the area under the tails of the curve  below).
...
$H_0: \mu_{\text{Biologists}} - \mu_{\text{Medics}} = \text{d} \rightarrow \mu_{\text{Biologists}} - \mu_{\text{Medics}} = 0 \rightarrow \mu_{\text{Biologists}} = \mu_{\text{Medics}}$ vs $H_1: \mu_{\text{Biologists}} \neq \mu_{\text{Medics}}$
...
Probability of getting an  F-statistic at least as extreme as the one we observe (think of the area under the tails of the curve below).
...
One possible explanation for an observed difference between groups, say in the [Inference about two means] section, is chance alone (i.e., it is by chance that we observe this difference)  
...
```{r random}
knitr::include_url("https://www.youtube.com/embed/zecArldpptY",height = "400")
```
...
**Null** hypothesis, $H_0$ (no difference) v. **Alternative** hypotheses, $H_1$ (there is a difference).
...
Begin work on your Executive Summary (worth  18\% of your final grade). You are free to work through the material provided and your final report. You may work in groups, however, the final report must be your **own** work. Your Executive Summary should be no more than one A4 page. If should concisely effectively communicate your hypothesis, the statistical analysis undertaken, and your findings. Please head over to the Assignments page of CANVAS for more details.
