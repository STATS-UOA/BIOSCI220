...
### Mathematical notation (basically the same)
...
```{r, echo = FALSE, results='asis'}
library(equatiomatic)
extract_eq(slm_null, wrap = TRUE, terms_per_line = 1)
```
---
...
ggplot(data = penguins_nafree, aes(x = bill_depth_mm)) +
  geom_histogram() + theme_classic() +
  xlab("Bill depth (mm)") +
  geom_hline(yintercept = summary(slm_null)$coef[1,1])
...
##  Linear regression with a continuous explanatory variable
